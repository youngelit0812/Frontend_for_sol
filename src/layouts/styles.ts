...
export const HeaderOperatorContainer = styled.div`
  align-items: center;
...
export const HeaderWrapper = styled.div`
  ...
  background-image: linear-gradient(0deg, #191f2d, #191f2d),
    linear-gradient(
      269.92deg,
      rgba(149, 161, 180, 0.15),
      rgba(1, 3, 20, 0.5) 20.69%,
      rgba(149, 161, 180, 0.15) 49.94%,
      rgba(1, 3, 20, 0.5) 81.52%,
      rgba(149, 161, 180, 0.15)
    );
...
export const MintButton = styled.div<{ $bg?: boolean }>`
  ...
  background: ${({ $bg }) =>
    $bg &&
    "linear-gradient(277.33deg, #18a672, #5ec03a 47.21%, #15a1b7 93.62%)"};
  img {
    margin-right: 10px;
  }
`;
